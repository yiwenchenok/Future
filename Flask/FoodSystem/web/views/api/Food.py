...
from web.models.member.MemberCart import MemberCart
...
def foodInfo():
    ...
    #print(resp)
    '''{'code': 200, 'msg': '操作成功~', 'data': {'info': {'id': 2, 'name': '番茄炒鸡蛋', 
    'summary': '<p><img src="http://127.0.0.1:8999/static/upload/20220803/b8673351bf68449f94a9f74505420d00.jpg"/></p>
    <p>超级好吃的番茄炒鸡蛋</p><p><img src="http://127.0.0.1:8999/static/upload/20220803/0a159c0d40b14e4cba9f76e6f5850c61.jpg"/></p>', 
    'total_count': 0, 'comment_count': 0, 'main_image': 'http://127.0.0.1:8999/static/upload/20220803/7d90f2ae63fb4520ad4159d35be705cb.jpg', 
    'price': '15.00', 'stock': 2, 'pics': ['http://127.0.0.1:8999/static/upload/20220803/7d90f2ae63fb4520ad4159d35be705cb.jpg']}, 'cart_number': 0}}
    '''
    return jsonify(resp)
