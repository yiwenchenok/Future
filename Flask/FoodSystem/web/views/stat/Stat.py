...
from web.models.stat.StatDailySite import StatDailySite
from web.models.stat.StatDailyFood import StatDailyFood
from web.models.stat.StatDailyMember import StatDailyMember
...
def index():
    ...
    return my_render_template( "stat/index.html",resp_data )
...
def food():
    ...
    return my_render_template( "stat/food.html",resp_data  )
...
def memebr():
    ...
    return my_render_template( "stat/member.html",resp_data  )
...
def share():
    ...
    return my_render_template( "stat/share.html",resp_data  )
