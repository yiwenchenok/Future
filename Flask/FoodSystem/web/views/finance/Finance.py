...
def index():
    ...
    return my_render_template("finance/index.html", resp_data)
...
def info():
    ...
    resp_data['current'] = 'index'
    return my_render_template("finance/pay_info.html", resp_data)
...
def set():
    ...
    return my_render_template("finance/account.html", resp_data)
